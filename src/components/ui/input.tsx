...
const inputVariants = cva(
  ...
  'flex w-full rounded-md border border-input bg-card px-3 text-sm ring-offset-white file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 touch-manipulation dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100 dark:ring-offset-gray-950 dark:placeholder:text-disabled dark:focus-visible:ring-blue-400',
  {
    variants: {
      inputSize: {
