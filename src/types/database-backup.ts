...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      // =============================================
      // Dedicated RFIs Table (Construction Industry Standard)
      // =============================================
      rfis: {
        Row: {
          id: string
      ...
      // =============================================
      // Dedicated Submittals Table (Construction Industry Standard)
      // =============================================
      submittals: {
        Row: {
          id: string
...
export type {
  ...
  CreateInput,
  TakeoffItem,
  // Weather Logs exports
  WeatherLog,
  WeatherCondition,
  PrecipitationType,
  WindDirection,
  WorkImpact,
  // Site Instructions exports
  SiteInstruction,
  SiteInstructionStatus,
  SiteInstructionPriority,
  // RFI exports (Construction Industry Standard)
  RFI,
  RFIInsert,
  RFIUpdate,
  RFIAttachment,
  ...
  RFIPriority,
  BallInCourtRole,
  // Submittal exports (Construction Industry Standard)
  Submittal,
  SubmittalInsert,
  SubmittalUpdate,
  SubmittalItem,
