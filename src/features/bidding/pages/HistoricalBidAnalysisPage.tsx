    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-t mt-12">
        <div className="container mx-auto px-4 py-8">
          <h3 className="text-lg font-semibold mb-4">About Historical Bid Analysis</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-muted-foreground">
            <div>
              <h4 className="font-medium text-foreground mb-2">Vendor Performance</h4>
              <p>
            ...
            <div>
              <h4 className="font-medium text-foreground mb-2">Bid Accuracy</h4>
              <p>
