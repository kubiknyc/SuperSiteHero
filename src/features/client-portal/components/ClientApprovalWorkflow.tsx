      ...
      <div className={cn('max-w-2xl mx-auto p-6', className)}>
        <div className="bg-white rounded-lg shadow-sm border p-8 text-center">
          <div className={cn(
            ...
            response.decision === 'approved' ? 'bg-green-100' :
            response.decision === 'rejected' ? 'bg-red-100' : 'bg-yellow-100'
          )}>
          ...
          <div className="bg-gray-50 rounded-lg p-4 text-left">
            <p className="text-sm text-gray-500">Your Decision:</p>
            <p className="font-medium text-gray-900 capitalize">{response.decision.replace('_', ' ')}</p>
            {response.comments && (
              <>
                <p className="text-sm text-gray-500 mt-3">Comments:</p>
                <p className="text-gray-900">{response.comments}</p>
              </>
            )}
            <p className="text-sm text-gray-500 mt-3">Submitted:</p>
    ...
    <div className={cn('max-w-2xl mx-auto', className)}>
      ...
      <div className="bg-white rounded-t-lg border border-b-0 p-6">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-sm text-gray-500 mb-1">{data.project.company_name}</p>
      ...
      {/* Entity Details */}
      <div className="bg-gray-50 border-x px-6 py-4">
        ...
        {data.entity_details.attachments && data.entity_details.attachments.length > 0 && (
          <div className="mt-4">
            <dt className="text-sm text-gray-500 mb-2">Attachments</dt>
      ...
      {/* Approval Form */}
      <form onSubmit={handleSubmit} className="bg-white rounded-b-lg border p-6">
        {/* Decision Selection */}
        <div className="mb-6">
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-gray-700 mb-1">
            Comments {decision === 'changes_requested' && <span className="text-red-500">*</span>}
          </label>
          <textarea
            value={comments}
