...
export function ExpirationBadge({
  ...
  if (daysUntil <= 7) {
    return (
      <Badge className={cn('gap-1 bg-red-100 text-red-800 hover:bg-red-100', className)}>
  ...
  return (
    <Badge className={cn('gap-1 bg-green-100 text-green-800 hover:bg-green-100', className)}>
