    ...
    <div className={cn('space-y-4', className)}>
      ...
      <div className="flex items-center gap-3">
        ...
        <Button
          ...
          className={cn(hasActiveFilters && 'border-blue-500 text-primary')}
        >
          <Filter className="h-4 w-4 mr-2" />
          Filters
          {hasActiveFilters && (
            <span className="ml-2 bg-info-light text-primary text-xs px-1.5 py-0.5 rounded-full">
              {
      ...
      {/* Expanded filters */}
      {isExpanded && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-surface rounded-lg border">
          {/* Status filter */}
          <div>
