...
export default function Concept5BoldContrast() {
  return (
    <div className="min-h-screen bg-card" style={{ fontFamily: '"Courier New", monospace' }}>
        ...
        <div className="border-8 border-black p-12 mb-12">
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <button className="px-10 py-5 bg-card text-black font-bold text-lg border-4 border-black hover:bg-black hover:text-white transition">
                SECONDARY
              </button>
            </div>
