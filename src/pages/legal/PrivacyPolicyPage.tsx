    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <h1 className="heading-page mb-2">Privacy Policy</h1>
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          <section>
            <h2 className="heading-section mb-4">1. Introduction</h2>
          ...
          <section>
            <h2 className="heading-section mb-4">2. Information We Collect</h2>

            <h3 className="heading-card mt-6 mb-3">Personal Information</h3>
            ...
            <h3 className="heading-card mt-6 mb-3">Project Data</h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <h3 className="heading-card mt-6 mb-3">Location Information</h3>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h3 className="heading-card mt-6 mb-3">Device Information</h3>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <h3 className="heading-card mt-6 mb-3">Usage Data</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="heading-section mb-4">3. How We Use Your Information</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <section>
            <h2 className="heading-section mb-4">4. Data Sharing and Disclosure</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <section>
            <h2 className="heading-section mb-4">5. Data Security</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="heading-section mb-4">6. Data Retention</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="heading-section mb-4">7. Your Rights</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
          ...
          <section>
            <h2 className="heading-section mb-4">8. Children's Privacy</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="heading-section mb-4">9. International Data Transfers</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="heading-section mb-4">10. Changes to This Privacy Policy</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="heading-section mb-4">11. Contact Us</h2>
            <p className="text-muted-foreground leading-relaxed">
