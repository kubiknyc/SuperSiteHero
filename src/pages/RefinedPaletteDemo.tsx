  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-shadow">
      ...
      <div className="p-5 space-y-4">
        {/* Tagline & Description */}
        <div>
          <p className="font-semibold text-gray-800 dark:text-gray-200">{palette.tagline}</p>
        ...
        {/* Card Sample */}
        <div className="rounded-lg border border-gray-200 dark:border-gray-700 p-3 group hover:shadow-md transition-shadow relative overflow-hidden">
          <div
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-semibold text-gray-900 dark:text-white text-sm">Daily Report</p>
