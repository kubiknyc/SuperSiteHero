/**
 * Update user role with admin access (uses service role key)
 * Run with: npx tsx scripts/update-role-admin.ts <user-id> <new-role>
 */
...
async function updateUserRole(userId: string, newRole: string) {
  console.log('🔧 Updating user role (admin mode)...')
  ...
  console.log()
  console.log('✅ Role updated successfully')
  console.log(`✅ ${currentUser.first_name} can now perform actions allowed by ${newRole}`)
  console.log()
  console.log('Next steps:')
  console.log('1. In the browser, open DevTools (F12) and run:')
  console.log('   localStorage.clear()')
  console.log('   sessionStorage.clear()')
  console.log('2. Refresh the page (F5)')
  console.log('3. Log out and log back in')
  console.log('4. Try creating a project again')
  console.log()
}
...
if (!userId || !newRole) {
  console.error('Usage: npx tsx scripts/update-role-admin.ts <user-id> <new-role>')
  console.error('Example: npx tsx scripts/update-role-admin.ts b7f15635-5d79-44af-954f-d12689d7e7b6 project_manager')
  console.error()
