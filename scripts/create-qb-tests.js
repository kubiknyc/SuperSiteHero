/**
 * Script to create complete QuickBooks edge function tests
 */
...
const testsDir = path.join(__dirname, '..', 'supabase', 'functions', '__tests__');

// qb-get-auth-url.test.ts
const qbGetAuthUrlTest = `/**
...
fs.writeFileSync(path.join(testsDir, 'qb-get-auth-url.test.ts'), qbGetAuthUrlTest);
console.log('Created qb-get-auth-url.test.ts');
